...
int main() {
    ...
    if (sockid < 0) printf("Socket creation failed\n");
    ...
    if (sockid2 < 0) printf("Binding failed\n");
    ...
    while (1) {
        ...
        send(nds, sendmsg, strlen(sendmsg)+1, 0);
    }
